...
build:
	CGO_ENABLED=0	gox -osarch "${ARCHS}" -ldflags "-X github.com/teamslizco/inspector-dp/main.version=${VERSION} -X github.com/teamslizco/inspector-dp/main.gitHash=${GIT_HASH}"  -output pkg/{{.OS}}_{{.Arch}}/inspectordp
